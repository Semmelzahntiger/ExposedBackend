...
import com.semmelzahntiger.brainrotbackend.socket.protocol.outgoing.GameScoreStateMessage;
...
import com.semmelzahntiger.brainrotbackend.socket.protocol.outgoing.UpdateLobbyStateMessage;
...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = UpdateLobbyStateMessage.class, name = ProtocolDefinition.UPDATE_LOBBY_STATE_MESSAGE),
        ...
        @JsonSubTypes.Type(value = GameScoreStateMessage.class, name = ProtocolDefinition.GAME_SCORE_STATE_MESSAGE),
